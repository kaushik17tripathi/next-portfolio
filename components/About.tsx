...
import profilePic from "public/extraImages/heroImage.webp";
    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          <br />
          <br /> Currently I am pursuing B.Tech in Information Technology
          from{' '}
          <span className="text-blue-500 font-semibold">
            JSS Academy of Technical Education, Noida
          </span> and have keen interest in different technologies and development
          <br/>
          <br /> I am always open to new opportunities and challenges. Feel free to reach out to me for any project or collaboration. 
        </p>
      </div>
    </motion.div>
  );
